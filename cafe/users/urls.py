...
urlpatterns = [
    ...
    path("staff_login/", views.StaffLogin.as_view(), name="staff_login"),
    path("staff_login/staff/otp/", views.CheckOtp.as_view(), name="check-otp"),
    ...
    path("peak_business_hour/", PeakBusinessHourView.as_view(), name="peak_business_hour"),
    ...
    path("history_for_manager/", views.CustomerHistory.as_view(), name="history_for_manager",),
    path("popular_items_morning/", PopularItemsMorningView.as_view(), name="popular_items_morning",),
    path("status_count/", StatusCountView.as_view(), name="status_count"),
    path("order_status_report/", OrderStatusReportView.as_view(), name="order_status_report",),
